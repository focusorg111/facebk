...
(function($){
	...
	var defaults = {
		...
		draggable : false, //options: true, false
		...
		*/
		...
		setModalboxLayoutContainer_End : '</div></div></div></div>',
		...
		setTypeOfFadingLayer : 'custom', // options: white, black, custom, disable
